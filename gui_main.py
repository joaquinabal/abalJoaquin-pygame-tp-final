...
form_menu_B = FormMenuB(name="form_menu_B",master_surface= screen,x=0,y=0,w=ANCHO_VENTANA,h=ALTO_VENTANA,color_background=C_BLACK,color_border=None,active=False )
