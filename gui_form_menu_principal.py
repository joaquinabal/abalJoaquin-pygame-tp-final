...
class FormMenuPrincipal(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.boton_salir = Button(master=self,x=600,y=500,w=140,h=50,color_background=None,color_border=None,image_background="images/gui/set_gui_01/Data_Border/Buttons/Button_M_06.png",on_click=self.on_click_boton2,on_click_param="form_game_L3",text="Salir",font="Verdana",font_size=30,font_color=C_WHITE)
                                
        self.lista_widget = [self.boton_jugar,self.boton_niveles,self.boton_salir,self.title]
